  ...
  return (
    <div className="sticky top-0 z-50 w-full">
      <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#e6edf4] px-4 md:px-10 py-3 md:py-4 bg-white/70 backdrop-blur-md supports-[backdrop-filter]:bg-white/70 w-full">
        ...
        {/* Right: Chat and Mobile Menu */}
        <div className="flex items-center gap-4">
          {showNavigation && (
            <Link href="/chat">
              <button className="flex items-center gap-2 px-4 py-2 bg-[#0183ff] text-white rounded-lg hover:bg-[#0066cc] transition-all transform hover:scale-105 shadow-sm hover:shadow-md">
