    ...
    const suggestedActions = [
        {
            ...
            label: 'fund for me right now?',
            action: 'What is the best fund for me right now?',
        },
        {
            title: 'Which funds are',
            label: 'performing best currently?',
            action: 'Which funds are performing best currently?',
        },
        {
            title: 'Recommend funds based',
            label: 'on my risk profile',
            action: 'Recommend funds based on my risk profile',
        },
        {
            title: 'Compare top',
            label: 'mutual funds',
            action: 'Compare top mutual funds',
        },
    ];
